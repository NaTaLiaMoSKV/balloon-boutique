  ...
  const faqData = [
    {
      ...
      answer:
        "Оплатити замовлення можна двома способами: передоплата 30 відсотків (решта суми при отриманні) або повна оплата онлайн до доставки.",
    },
    {
      question: "Чи є можливість самовивозу?",
      answer:
        "Так, фізичний магазин розташований за адресою вул. Рашельєвська, 67.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Так, доставка доступна не лише по місту, але й у найближчі райони. У центральні райони міста доставка безкоштовна, далі — від 200 гривень.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Латексні кульки тримаються у повітрі від 2 до 5 днів, а фольговані — від 2 днів до місяця.",
    },
  ];

  return (
    <section id="faq">
      <h2 className="faq__title scroll-element scroll-element--from-bottom">
        <span>&#9135;</span> FAQ <span>&#9135;</span>
      </h2>

      {faqData.map((item, index) => (
        <div
          className="faq__item scroll-element scroll-element--from-bottom"
          key={index}
        >
          <button
          ...
          <div
            ...
            style={{
              maxHeight:
                activeIndex === index ? `${item.answer.length * 1.5}px` : "0",
            }}
          >
            <p>{item.answer}</p>
          </div>
